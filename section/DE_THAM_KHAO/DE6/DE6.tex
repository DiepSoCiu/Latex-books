...
\bt[THAM KHẢO (1,5)]
{
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        \item Tìm các điểm thuộc đồ thị hàm số đã cho có tung độ gấp đôi hoành độ.
    \end{enumerate}
}
\xdd 
\bt[TUYỂN SINH TP.HCM 2024-2025 (1)]
{
    Cho phương trình: $3x^2 -4x -2 = 0$
    \begin{enumerate}[label=\alph*)]
...
\bt[THAM KHẢO (1,5)]
{
    ...
    \begin{enumerate}[label=\alph*)]
        \item Tính số lượng cụ thể của mỗi loại bảo hiểm mà công ty đã bán được trong tháng 4/2025?
        \item Bộ phận chăm sóc khách hàng chọn ngẫu nhiên một khách hàng đã mua bảo hiểm của công ty trong tháng 4/2025 để khảo sát. Tính xác suất của biến cố: “Khách hàng được chọn không mua loại bảo hiểm B”.
    \end{enumerate}
}
% Hình
\begin{marginfigure}|-4cm|
    \centering
    \includegraphics[width=\marginparwidth]{section/DE_THAM_KHAO/DE6/Bieu_do.pdf}
    %\vspace{}
    \margincaption{Bài 3}
\end{marginfigure}
\xdd 
